...
/// <summary>
/// Handler for getting player by username
/// </summary>
public class GetPlayerByUsernameQueryHandler : QueryHandler<GetPlayerByUsernameQuery, PlayerDto?>
{
    private readonly IPlayerRepository _playerRepository;

    public GetPlayerByUsernameQueryHandler(
        IPlayerRepository playerRepository,
        ILogger<GetPlayerByUsernameQueryHandler> logger) : base(logger)
    {
        _playerRepository = playerRepository;
    }

    protected override async Task<Result<PlayerDto?>> HandleQuery(GetPlayerByUsernameQuery request, CancellationToken cancellationToken)
    {
