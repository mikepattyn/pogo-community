...
import { GymScreenContainerComponent } from './gym.screen.container.component';
    ...
    return (
      <View style={GymScreenStyles.container}>
        ...
        <InputDialog
          ...
          onPressOutside={this.onPressOutsideDialog}
          onChangeDialogInput={this.onChangeDialogInput}
          onSubmitDialog={this.onSubmitDialog}
        />
        {this.map}
      </View>
    );
