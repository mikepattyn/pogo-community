  ...
  render() {
    ...
    return (
      <ImageBackground
        ...
        style={{ width: '100%', height: '100%', backgroundColor: '#232424' }}
      >
        ...
        >
          <View
            style={{ flex: 1, justifyContent: 'space-evenly', width: '100%' }}
          >
            <Text
              style={{ fontSize: 20, color: '#e1e1e1', textAlign: 'center' }}
            >
              {this.propertyCommands[this.state.index]}
            </Text>
            <RegistrationInput
              index={this.state.index}
              onChange={(text: string) => this.onChangeText(text)}
        ...
        <Button
          ...
          buttonStyle={{ backgroundColor: '#2164E8', marginBottom: 20 }}
          title={this.state.currentButtonValue}
